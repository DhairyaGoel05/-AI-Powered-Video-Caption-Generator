...
def main():
    ...
    if uploaded_video:
        ...
        if st.button("Generate Captions"):
            ...
            ffmpeg_path = r"C:\Users\DHAIRYA\Downloads\ffmpeg-2025-04-14-git-3b2a9410ef-essentials_build\ffmpeg-2025-04-14-git-3b2a9410ef-essentials_build\bin\ffmpeg.exe"  # Update to your FFmpeg path
